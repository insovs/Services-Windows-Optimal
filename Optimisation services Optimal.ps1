...
echo "Auteur: inso.vs
Date de création: [28/06/2024] v0.1 (Version Optmimal)
...
$services = @(
    ...
    "BluetoothUserService"                     # Service (Bluetooth)
    "BluetoothUserService_33afb"               # Service de support des utilisateurs du Bluetooth_33afb (bluetooth)
    "BluetoothUserService_38117"               # Service de support des utilisateurs du Bluetooth_38117 (bluetooth)
    "BTAGService"                              # Service de passerelle audio Bluetooth (Bluetooth)
    "bthserv"                                  # Service de prise en charge Bluetooth (Bluetooth)               
    ...
    "AxInstSV"                                 # Programme d’installation ActiveX (AxInstSV)
    "AppXSvc"                                  # Service de deploiement AppX (AppXSVC)
    ...
    "XblGameSave"                              # Jeu sauvegardé sur Xbox Live
    "XboxNetApiSvc"                            # Service de mise en réseau Xbox Live
